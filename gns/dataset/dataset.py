...
from gns.utils.get_spec import get_specification
...
class Dataset:
    ...
    def read(self):
        """
        Should be redefined for inheritance.
        """
        raise NotImplementedError

    def download(self):
        """
        May be redefined for inheritance.
        """
        pass
    ...
    def map(self, transform, reduce=None):
        """
        Map/reduce function for class overloaded.
        """
        if not callable(transform):
            raise ValueError("`transform` must be a callable")
